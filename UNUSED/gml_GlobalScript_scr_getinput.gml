...
function scr_check_superjump() //gml_Script_scr_check_superjump
{
    ...
    if global.tas_mode == 2 // playback
    {
        return ((sj && obj_tasplayback.key_up) || obj_tasplayback.key_superjump)
    }
...
function scr_check_groundpound() //gml_Script_scr_check_groundpound
{
    ...
    if global.tas_mode == 2 // playback
    {
        return ((gp && obj_tasplayback.key_down2) || obj_tasplayback.key_groundpound)
    }
...
function scr_mach_check_dive() //gml_Script_scr_mach_check_dive
{
    if (grounded && vsp > 0)
        if global.tas_mode == 2 // playback
        {
            return obj_tasplayback.key_down
        }   
        return key_down;
...
function scr_check_groundpound2() //gml_Script_scr_check_groundpound2
{
    ...
    if global.tas_mode == 2 // playback
    {
        return ((gp && obj_tasplayback.key_down) || obj_tasplayback.key_groundpound2)
    }
...
function scr_switch_get_menu_input() //gml_Script_scr_switch_get_menu_input
{
    ...
    if global.tas_mode == 2 // playback
    {
        key_back = obj_tasplayback.key_attack
        key_jump = obj_tasplayback.key_jump
        key_jump2 = obj_tasplayback.key_jump2
    }
}
...
function scr_menu_getinput() //gml_Script_scr_menu_getinput
{
    ...
    if global.tas_mode == 2 // playback
    {
        key_up = obj_tasplayback.key_up
        key_up2 = obj_tasplayback.key_up2
        key_down = obj_tasplayback.key_down
        key_down2 = obj_tasplayback.key_down2
        key_left = obj_tasplayback.key_left
        key_left2 = obj_tasplayback.key_left2
        key_right = obj_tasplayback.key_right
        key_right2 = obj_tasplayback.key_right2
        key_start = obj_tasplayback.key_start
        key_back = obj_tasplayback.key_attack
        key_jump = obj_tasplayback.key_jump
        key_jump2 = obj_tasplayback.key_jump2
        key_delete = obj_tasplayback.key_taunt
        key_delete2 = obj_tasplayback.key_taunt2
        key_quit = obj_tasplayback.key_quit
        key_quit2 = obj_tasplayback.key_quit2
    }
    else
    {
        ...
        {
            _dvc = obj_inputAssigner.player_input_device[(!obj_inputAssigner.player_index)]
...
{
    _dvc = obj_inputAssigner.player_input_device[player_index]
    ...
    // now we override the important inputs with our tas inputs
    if global.tas_mode == 2 // playback
    {
        key_up = obj_tasplayback.key_up
        key_up2 = obj_tasplayback.key_up2
        ...
        key_right = obj_tasplayback.key_right
        key_right2 = obj_tasplayback.key_right2
        key_taunt = obj_tasplayback.key_taunt
        key_taunt2 = obj_tasplayback.key_taunt2
        key_jump = obj_tasplayback.key_jump
        key_jump2 = obj_tasplayback.key_jump2
        key_jump3 = obj_tasplayback.key_jump3
    }
}
